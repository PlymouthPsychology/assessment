...
# get statistics on each file
stats<-params$Data %>% group_by(file) %>% 
   summarise(N=n(),M=mean(Grade, na.rm=T),SD=sd(Grade, na.rm=T))
...
`r knitr::kable(stats, digits=2, caption="Question statistics")`
