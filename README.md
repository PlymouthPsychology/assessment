# A collection of R, Markdown and Shiny to support module leaders

* **AttendeR** - correlate marks, attendance and panopto. [http://jonmay.shinyapps.io/AttendeR](http://jonmay.shinyapps.io/AttendeR)
* **CombineR** - combine several assignments into a single weighted mark (e.g., S4 options, 2 CW -> 1 grade) [http://jonmay.shinyapps.io/CombineR](http://jonmay.shinyapps.io/CombineR)
* **Correlator** - correlate student gardes from multiple assignments or modules [http://jonmay.shinyapps.io/CorrelatoR](http://jonmay.shinyapps.io/CorrelatoR)
* **ExamineR** - Exam mark entry collation and moderation support [https://jonmay.shinyapps.io/ExamineR/](https://jonmay.shinyapps.io/ExamineR/)
